...
There is a big imbalance in regards to where the customers are located. Most of them live in Sau Paulo. This must have an impact for statistical validations and also for decisions which target Olist's business development.
